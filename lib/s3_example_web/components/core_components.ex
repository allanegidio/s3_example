defmodule S3ExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(S3ExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(S3ExampleWeb.Gettext, "errors", msg, opts)
    end
  end
